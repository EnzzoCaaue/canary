...
local exerciseWeaponsTable = {
	-- MELE
	[44780] = { skill = SKILL_SWORD },
	[44781] = { skill = SKILL_AXE },
	[44782] = { skill = SKILL_CLUB },
	-- ROD
	[44784] = { skill = SKILL_MAGLEVEL, effect = CONST_ANI_SMALLICE, allowFarUse = true },
	-- RANGE
	[44783] = { skill = SKILL_DISTANCE, effect = CONST_ANI_SIMPLEARROW, allowFarUse = true },
	-- WAND
	[44785] = { skill = SKILL_MAGLEVEL, effect = CONST_ANI_FIRE, allowFarUse = true },
}
...
local function exerciseTrainingEvent(playerId, tilePosition, weaponId, dummyId)
	...
	if isMagic then
		player:addManaSpent(100 * rate)
	else
		player:addSkillTries(exerciseWeaponsTable[weaponId].skill, 2.5 * rate)
	end
